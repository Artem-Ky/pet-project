...
const initialStatePlate: DeepPartial<StateSchema> = {
    articlesPage: {
...
const initialStateList: DeepPartial<StateSchema> = {
    articlesPage: {
        ids: article.map((article) => article.id),
        entities: article.reduce<Record<string, Article>>((acc, article) => {
            acc[article.id] = article;
...
LightPlate.args = {};
LightPlate.decorators = [StoreDecorator(initialStatePlate)];

export const DarkPlate = Template.bind({});
DarkPlate.args = {};
DarkPlate.decorators = [ThemeDecorator(Theme.DARK), StoreDecorator(initialStatePlate)];

export const LightList = Template.bind({});
LightList.args = {};
LightList.decorators = [StoreDecorator(initialStateList)];

export const DarkList = Template.bind({});
DarkList.args = {};
DarkList.decorators = [ThemeDecorator(Theme.DARK), StoreDecorator(initialStateList)];
